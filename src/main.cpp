...
unsigned int build_shader(unsigned int& vertexShader, unsigned int& fragmentShader);
...
int main()
{
    ...
    // -------------------------
    Shader shader("assets/shaders/5.2.framebuffers.vs", "assets/shaders/5.2.framebuffers.fs");
    Shader screenShader("assets/shaders/5.2.framebuffers_screen.vs", "assets/shaders/5.2.framebuffers_screen.fs");
