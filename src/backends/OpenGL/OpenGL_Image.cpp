...
// GLint OpenGL_Image::OpenGL_GetImageFormat(ImageFormat fmt)
// {
//     if (fmt == ImageFormat::RGBA) return GL_RGBA;
//     else if (fmt == ImageFormat::RGBA32F) return GL_RGBA32F;
//     return GL_FALSE;
// }
...
{
    glGenTextures(1, &m_RendererID); // OpenGL equivalent of vkCreateImage
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, textureFormat, m_Width, m_Height, 0, GL_RGBA, GL_UNSIGNED_BYTE, nullptr);
